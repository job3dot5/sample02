...
final class RouteTest extends KernelTestCase
{
    ...
    public function testImageJobStatusRouteReturnsUnauthorizedWithoutToken(): void
    {
        $response = $this->request('GET', '/api/v1/image-jobs/2cf8bd7572819cdb2288f72389f96a53');
